...
-- -----------------------------------------------------
-- Table `mydb`.`Valor mao de obra`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Valor mao de obra` (
...
CREATE TABLE IF NOT EXISTS `mydb`.`Veiculo` (
  ...
  CONSTRAINT `fk_Veiculo_Valor mao de obra1`
    ...
    REFERENCES `mydb`.`Valor mao de obra` (`idValor mao de obra`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`Finalizado`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Finalizado` (
...
CREATE TABLE IF NOT EXISTS `mydb`.`Mecanico` (
  ...
  CONSTRAINT `fk_Mecanico_Finalizado1`
    ...
    REFERENCES `mydb`.`Finalizado` (`idFinalizado`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`Cliente solicita serviço`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Cliente solicita serviço` (
  ...
  CONSTRAINT `fk_Serviço_has_Cliente_Cliente1`
    ...
    REFERENCES `mydb`.`Cliente` (`idCliente` , `Veiculo_idVeiculo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`Cliente escolha serviço`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Cliente escolha serviço` (
  `Cliente_idCliente` INT NOT NULL,
  `Cliente_Veiculo_idVeiculo` INT NOT NULL,
  `Serviço_idServiço` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `mydb`.`Escolha da especialidade`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Escolha da especialidade` (
  `Ordem de serviço_idOrdem de serviço` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `mydb`.`Analisa veiculo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Analisa veiculo` (
  `Veiculo_idVeiculo` INT NOT NULL,
  `Mecanico_idMecanico` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `mydb`.`Mecanico_has_Valor mao de obra`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Mecanico_has_Valor mao de obra` (
  `Mecanico_idMecanico` INT NOT NULL,
  `Valor mao de obra_idValor mao de obra` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `mydb`.`Mecanico_has_estoque`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Mecanico_has_estoque` (
  `Mecanico_idMecanico` INT NOT NULL,
